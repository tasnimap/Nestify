...
public sealed class HelperWorkspaceService
{
    ...
    private sealed class RequestRow {public long Id{get;set;}public string ClientName{get;set;}="";public bool ClientVerified{get;set;}public DateTime RequestedAtUtc{get;set;}public string? Area{get;set;}public string? HomeType{get;set;}public List<string>? Services{get;set;}public decimal OfferedRate{get;set;}public string? Message{get;set;}public string? DeclineReason{get;set;}}
